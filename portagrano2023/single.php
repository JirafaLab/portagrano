...
<?php
					...
					echo '<div class = "single-noticia-entradilla">';
						the_field('entradilla');
					echo '</div>';
					echo '<div class="texto-noticia">';
						echo $texto;
					echo '</div>';
					echo '<div class = "texto-post-noticia">';
						the_field('texto_despues_noticia');
					echo '</div>';
...
<?php
	// Sin filtro / limite 4 / Excluir la actual
